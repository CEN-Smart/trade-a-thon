...
const HomePage = () => {
  return (
    <>
      <HeroSection />
      <Container className="flex lg:w-1/2 w-full -mt-[4rem] items-start overflow-auto gap-2 justify-between lg:-mt-[5.5rem] z-30 py-4 relative">
      ...
      <Container className="py-32 ">
        <h1 className="w-full md:w-1/2 mx-auto text-center pb-3">
          <Heading
